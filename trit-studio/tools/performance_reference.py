#!/usr/bin/env python3
"""Independent Python checks of v16 retained optimization semantics. NOT execution of C# or a C# speed benchmark."""
...
if __name__=='__main__':
    ...
    (ROOT/'reports/performance-reference-v16.json').write_text(json.dumps(report,indent=2)+'\n')
