...
{
    public const string Version = "conversation-ru-v22";
    public static TrainingExample[] Load(string directory, string name, CancellationToken ct = default)
    {
        ct.ThrowIfCancellationRequested();
        if (name is not ("conversation-language.jsonl" or "conversation-transfer.jsonl" or "seed.jsonl" or "validation.jsonl" or "test.jsonl" or "challenge.jsonl" or "challenge-v4.jsonl" or "challenge-v5.jsonl" or "challenge-v6.jsonl" or "challenge-v7.jsonl" or "challenge-v8.jsonl" or "challenge-v9.jsonl" or "challenge-v10.jsonl" or "challenge-v11.jsonl" or "challenge-v12.jsonl" or "challenge-v13.jsonl" or "challenge-v14.jsonl" or "challenge-v15.jsonl" or "challenge-v16.jsonl" or "challenge-v17.jsonl" or "challenge-v18.jsonl" or "challenge-v19.jsonl" or "transfer-challenge.jsonl" or "context-challenge.jsonl" or "challenge-v20.jsonl" or "conversation-context.jsonl" or "conversation-starter.jsonl" or "pretrain.jsonl"))
        ...
        var rows = name is "conversation-language.jsonl" or "conversation-transfer.jsonl" or "seed.jsonl" or "conversation-context.jsonl" or "conversation-starter.jsonl" or "pretrain.jsonl" ? Dataset.LoadTraining(path, ct) : Dataset.Load(path, ct);
